...
define(['knockout', 'text!templates/manual-wrapper.html', 'text!json/svg-headers.json', 'text!json/page-sections.json'], function (ko, htmlString, headersJson, sectionsJSON) {
  function ManualSection(params) {
    ...
    self.manualContent = ko.pureComputed(function () {
      return self.sections.find(function (s) {
        return s.component === self.display().manualSection;
      }).component;
    });
