define(['knockout', 'text!templates/manual/manual-oauth.html', "modules/manual/manual-section", 
    "text!json/formatted-html/request-auth.json", "text!json/oauth.json"], function (ko, htmlString, ManualSection, 
