...
--
-- Current Database: `iatserver_db`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `iatserver_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
--
-- Dumping data for table `admin_timers`
--

LOCK TABLES `admin_timers` WRITE;
/*!40000 ALTER TABLE `admin_timers` DISABLE KEYS */;
/*!40000 ALTER TABLE `admin_timers` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `client_exception`
--

LOCK TABLES `client_exception` WRITE;
/*!40000 ALTER TABLE `client_exception` DISABLE KEYS */;
/*!40000 ALTER TABLE `client_exception` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `cors_origins`
--

LOCK TABLES `cors_origins` WRITE;
/*!40000 ALTER TABLE `cors_origins` DISABLE KEYS */;
/*!40000 ALTER TABLE `cors_origins` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `deployment_packets`
--

LOCK TABLES `deployment_packets` WRITE;
/*!40000 ALTER TABLE `deployment_packets` DISABLE KEYS */;
/*!40000 ALTER TABLE `deployment_packets` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `deployment_sessions`
--

LOCK TABLES `deployment_sessions` WRITE;
/*!40000 ALTER TABLE `deployment_sessions` DISABLE KEYS */;
/*!40000 ALTER TABLE `deployment_sessions` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `dynamic_specifiers`
--

LOCK TABLES `dynamic_specifiers` WRITE;
/*!40000 ALTER TABLE `dynamic_specifiers` DISABLE KEYS */;
/*!40000 ALTER TABLE `dynamic_specifiers` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `item_slides`
--

LOCK TABLES `item_slides` WRITE;
/*!40000 ALTER TABLE `item_slides` DISABLE KEYS */;
/*!40000 ALTER TABLE `item_slides` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `manifest_files`
--

LOCK TABLES `manifest_files` WRITE;
/*!40000 ALTER TABLE `manifest_files` DISABLE KEYS */;
/*!40000 ALTER TABLE `manifest_files` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `mask_specifiers`
--

LOCK TABLES `mask_specifiers` WRITE;
/*!40000 ALTER TABLE `mask_specifiers` DISABLE KEYS */;
/*!40000 ALTER TABLE `mask_specifiers` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `oauth_access`
--

LOCK TABLES `oauth_access` WRITE;
/*!40000 ALTER TABLE `oauth_access` DISABLE KEYS */;
/*!40000 ALTER TABLE `oauth_access` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `range_specifiers`
--

LOCK TABLES `range_specifiers` WRITE;
/*!40000 ALTER TABLE `range_specifiers` DISABLE KEYS */;
/*!40000 ALTER TABLE `range_specifiers` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `resource_prices`
--

LOCK TABLES `resource_prices` WRITE;
/*!40000 ALTER TABLE `resource_prices` DISABLE KEYS */;
/*!40000 ALTER TABLE `resource_prices` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `rsa_key_data`
--

LOCK TABLES `rsa_key_data` WRITE;
/*!40000 ALTER TABLE `rsa_key_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `rsa_key_data` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `selection_specifiers`
--

LOCK TABLES `selection_specifiers` WRITE;
/*!40000 ALTER TABLE `selection_specifiers` DISABLE KEYS */;
/*!40000 ALTER TABLE `selection_specifiers` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `specifier_values`
--

LOCK TABLES `specifier_values` WRITE;
/*!40000 ALTER TABLE `specifier_values` DISABLE KEYS */;
/*!40000 ALTER TABLE `specifier_values` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `test_backup_files`
--

LOCK TABLES `test_backup_files` WRITE;
/*!40000 ALTER TABLE `test_backup_files` DISABLE KEYS */;
/*!40000 ALTER TABLE `test_backup_files` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `test_code`
--
...
--
-- Dumping data for table `test_encryption_keys`
--

LOCK TABLES `test_encryption_keys` WRITE;
/*!40000 ALTER TABLE `test_encryption_keys` DISABLE KEYS */;
/*!40000 ALTER TABLE `test_encryption_keys` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `test_resources` WRITE;
/*!40000 ALTER TABLE `test_resources` DISABLE KEYS */;
/*!40000 ALTER TABLE `test_resources` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `test_result_fragments`
--

LOCK TABLES `test_result_fragments` WRITE;
/*!40000 ALTER TABLE `test_result_fragments` DISABLE KEYS */;
/*!40000 ALTER TABLE `test_result_fragments` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `test_segments`
--

LOCK TABLES `test_segments` WRITE;
/*!40000 ALTER TABLE `test_segments` DISABLE KEYS */;
/*!40000 ALTER TABLE `test_segments` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `true_false_specifiers`
--

LOCK TABLES `true_false_specifiers` WRITE;
/*!40000 ALTER TABLE `true_false_specifiers` DISABLE KEYS */;
/*!40000 ALTER TABLE `true_false_specifiers` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `unique_response_items`
--

LOCK TABLES `unique_response_items` WRITE;
/*!40000 ALTER TABLE `unique_response_items` DISABLE KEYS */;
/*!40000 ALTER TABLE `unique_response_items` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `unique_responses`
--

LOCK TABLES `unique_responses` WRITE;
/*!40000 ALTER TABLE `unique_responses` DISABLE KEYS */;
/*!40000 ALTER TABLE `unique_responses` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-11-01 18:43:09

create user 'IATServer'@'localhost' identified by 'ezasabcdefg';
